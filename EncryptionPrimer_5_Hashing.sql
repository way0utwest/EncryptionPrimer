...
-- Basic hashing using a function
...
-- Steve's password is lost
-- this could be guessed more easily. Using a salt from a different table or with a scalar might help
-- Need to ensure non-privileged users can't read the proc code.
